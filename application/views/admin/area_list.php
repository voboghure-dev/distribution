<div id="center-column">
  ...
  <div class="table">
    ...
    <table class="listing" cellpadding="0" cellspacing="0">
      <tr>
        <th class="full" colspan="5">Area List</th>
      </tr>
      <tr>
      ...
      ?>
        <tr <?php if ($i == 1) { echo 'class="bg"'; } ?>>
          ...
          <td><a href="settings/area_edit/<?php echo $value['id']; ?>"><img src="images/edit-icon.gif" width="16" height="16" alt="edit" /></a></td>
...
<script type="text/javascript">
  $(function(){
    $('.delete').click(function(){
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>settings/area_delete",
