  ...
  <div class="table">
    ...
    <table class="listing" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td><a href="raw_inventory/edit_supply/<?php echo $value['id']; ?>"><img src="images/edit-icon.gif" width="16" height="16" alt="edit" /></a></td>
...
<script type="text/javascript">
  $(function(){
    $('.delete').click(function(){
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>raw_inventory/delete_supply",
