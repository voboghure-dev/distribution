<div id="center-column">
  <div class="table">
    ...
    <?php echo form_open('raw_inventory/add_supply_item'); ?>
    <table class="listing form" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td class="last">
          <?php echo form_dropdown('item_id', $raw_items, '', 'style="width: 270px;"'); ?>
        </td>
      </tr>
...
<script type="text/javascript">
  $(function(){
    $('.delete').click(function(){
      ...
      $.ajax({
         type: "POST",
         url: "<?php echo base_url(); ?>raw_inventory/delete_supply_item",
