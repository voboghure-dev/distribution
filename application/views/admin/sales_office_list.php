<div id="center-column">
  ...
  <div class="table">
    ...
    <table class="listing" cellpadding="0" cellspacing="0">
      <tr>
        <th class="full" colspan="5">Sales Office List</th>
      </tr>
      <tr>
        <th width="177">Serial</th>
      ...
      ?>
        <tr <?php if ($i == 1) { echo 'class="bg"'; } ?>>
          <td class="first style1"><?php echo $j; ?></td>
          <td><?php echo $value['name']; ?></td>
          <td><?php echo $value['edate']; ?></td>
          <td><a href="settings/sales_office_edit/<?php echo $value['id']; ?>"><img src="images/edit-icon.gif" width="16" height="16" alt="edit" /></a></td>
...
<script type="text/javascript">
  $(function(){
    $('.delete').click(function(){
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>settings/sales_office_delete",
