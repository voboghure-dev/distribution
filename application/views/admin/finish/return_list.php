<div id="center-column">
  ...
  <div class="table">
    ...
    <table class="listing" cellpadding="0" cellspacing="0">
      <tr>
        <th class="full" colspan="7">Sales Return List</th>
      </tr>
      <tr>
      ...
      <tr <?php if($i==1){echo 'class="bg"';} ?>>
        <td class="first style1"><?php echo $value['return_no']; ?></td>
        <td><?php echo $value['employee']; ?></td>
        <td><?php echo $value['customer']; ?></td>
        <td><?php echo $value['quantity']; ?></td>
        <td><?php echo $value['edate']; ?></td>
        <td><a href="finish_inventory/edit_sales/<?php echo $value['id']; ?>"><img src="images/edit-icon.gif" width="16" height="16" alt="edit" /></a></td>
...
<script type="text/javascript">
  $(function(){
    $('.delete').click(function(){
      ...
      $.ajax({
         type: "POST",
         url: "<?php echo base_url(); ?>finish_inventory/delete_return",
