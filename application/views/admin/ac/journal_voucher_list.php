<div id="center-column">
  ...
  <div class="table">
    ...
    <table class="listing" cellpadding="0" cellspacing="0">
      <tr>
        <th class="full" colspan="8">Journal Voucher List</th>
      </tr>
      <tr>
      ...
      <tr <?php if($i==1){echo 'class="bg"';} ?>>
        ...
        <td style="text-align: center;"><a href="accounts/edit_journal_voucher_master/<?php echo $value['id']; ?>"><img src="images/edit-icon.gif" width="16" height="16" alt="edit" /></a></td>
